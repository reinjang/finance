          ...
          <Line data={chartData} options={{
            ...
            plugins: {
              ...
              legend: {
                ...
                labels: {
                  ...
                  font: { size: 16, weight: 'normal', family: 'Nunito, Inter, sans-serif' },
                  boxWidth: 18,
                  padding: 12,
                }
              }
            ...
            scales: {
              x: {
                ...
                ticks: { ...chartOptions.scales.x.ticks, font: { size: 16, family: 'Nunito, Inter, sans-serif' } }
              },
              y: {
                ...chartOptions.scales.y,
                ticks: { ...chartOptions.scales.y.ticks, font: { size: 16, family: 'Nunito, Inter, sans-serif' } }
              }
            }
          }} />
        </div>
