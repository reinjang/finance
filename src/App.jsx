...
function App() {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center">
      <div className="w-full max-w-7xl mx-auto flex justify-center items-center px-2 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr,1.5fr] gap-6 w-full min-h-0 px-4 md:px-10 lg:px-16 xl:px-24 h-full mx-auto">
